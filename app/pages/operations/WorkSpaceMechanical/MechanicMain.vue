    ...
    <div class="flex w-full h-full space-x-6">
      <div class="flex-1 rounded-lg flex flex-col overflow-hidden">
        ...
        <div class="flex-1 bg-transparent">
          ...
          <div v-if="currentView === 'reports'" class="text-gray-500">
...
<script setup>
import { ref } from 'vue'
import BossReception from './MechanicReception.vue'
import BossKanban from './MechanicDashboard.vue'
import TableConfirm from '../WorkSpaceBoss/historial.vue'
