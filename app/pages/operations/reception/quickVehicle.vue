<template>
  <div class="page-container">
      ...
      <div class="filters-container">
        ...
        >
          ...
          <select v-model="filterValues[field.key]" class="filter-select">
            ...
            <option
              v-for="option in getUniqueOptions(field.key)"
              :key="option"
              :value="option"
            >
    ...
    <div v-if="filteredCars.length > 0" class="cards-section">
      ...
      >
        ...
        <div class="car-info">
          ...
          <div><strong>Transmision:</strong> {{ car.transmision }}</div>
        </div>
        <div class="card-actions">
          <button class="reception-button-new">Procesar Coche</button>
        </div>
      </div>
    </div>
    ...
    <ReceptionDetails
      ...
      @hide-details="hideReceptionDetails"
      class="reception-details-section"
      id="reception-details-section"
    />
  </div>
</template>
...
import ReceptionDetails from './carSearch.vue';
...
function selectCar(car) {
  ...
  nextTick(() => {
    const el = document.getElementById('reception-details-section');
    if (el) {
